...
public class ProfessionalController {
    ...
    @Operation(
            ...
            description = "Creates the profile for the authenticated user with the PROFESSIONAL role"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "Returns the professional profile of the authenticated user with the PROFESSIONAL role"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Partially updates the professional profile of the authenticated user with the PROFESSIONAL role"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "List all professional profiles",
            description = "Returns all professional profiles. Available for OWNER and PROFESSIONAL roles"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Returns a professional profile by its ID. Available for OWNER and PROFESSIONAL roles"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
